package Bot::BasicBot::Pluggable::Module::ASInfobot;
...
sub get_raw_factoids {
    ...
    $self->tell("#lordtaco", "IS: ".$is_are." ".@factoids);
...
sub store {
  my $self = shift;
  my $storeage = Bot::BasicBot::Pluggable::Store::Deep->new(
    file => "infobot.deep"
  );   
  return $storeage;
}
